...
| --------------------------- | ---------------------- | ----------------------------------- | ------ | ------------------------------------------------------------------------------ |
| `rule_type`                 | セレクト or セグメント | 通常 / 少数派 / 代表 / トーナメント | 通常   | 常時。**現状は通常のみ選択可**（少数派・代表・トーナメントは非活性）。backend アルゴリズム実装済み。有効化は `TODO.md` R6（統合 R0–R5 完了後） |
...
### 4.2.1 ゲーム画面 — 特殊ルール（統合後・`TODO.md` R6）
