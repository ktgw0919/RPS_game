...
- [`docs/TODO.md`](docs/TODO.md) — 実装フェーズ（Phase 1–4）
- [`docs/CONTRIBUTING.md`](docs/CONTRIBUTING.md) — Git 運用方針（ブランチ・コミット・PR・進捗ドキュメント同期 §9）
...
**MVP 残タスク**（[`docs/TODO.md`](docs/TODO.md) 末尾）: `match_history` の MongoDB 永続化、QR 共有、退室（`LEAVE`）UI。
